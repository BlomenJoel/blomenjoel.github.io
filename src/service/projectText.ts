export const projectText = [
  {
    rubric: "Kamera app",
    description: "Som kamera entusiast fotar jag en del analogt, och en stor del av processen är att ha ställa in kameran efter ljusförhållandet. Så jag gjorde en mobil webb applikation lösning på det!",
